...
public:
    ...
    void setVariableMark(signed long int _id) { append(AssemblyItem(VariableMark, _id)); }
    void setVariableEndMark(signed long int _id) { append(AssemblyItem(VariableEndMark, _id)); }
